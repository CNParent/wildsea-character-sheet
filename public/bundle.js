(function () {
    ...
    function create_else_block$4(ctx) {
    	...
    	function select_block_type_1(ctx, dirty) {
    		if (/*matches*/ ctx[2].length == 0) return create_if_block_1$3;
    ...
    function create_fragment$b(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*active*/ ctx[3]) return create_if_block$7;
    ...
    class TextArea extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$b, create_fragment$b, safe_not_equal, { content: 0, highlight: 8, label: 1 });
    	}
    }
    ...
    function create_if_block$6(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block = /*label*/ ctx[1] && create_if_block_1$2(ctx);
    ...
    class TextInput extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$a, create_fragment$a, safe_not_equal, { content: 0, label: 1 });
    	}
    }
    ...
    class ListItem extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$8, create_fragment$8, safe_not_equal, { move: 0, remove: 1, item: 2 });
    	}
    }
    ...
    function create_fragment$7(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div6, "class", "ml-1 flex-grow-1");
    			attr(div7, "class", "d-flex");
    			attr(div8, "class", "flew-grow-1");
    		},
    		m(target, anchor) {
    ...
    function create_else_block$2(ctx) {
    	...
    	function textinput_value_binding(value) {
    		/*textinput_value_binding*/ ctx[7](value, /*item*/ ctx[8], /*each_value*/ ctx[9], /*item_index*/ ctx[10]);
    	}

    	let textinput_props = {};

    	if (/*item*/ ctx[8] !== void 0) {
    		textinput_props.value = /*item*/ ctx[8];
    	}
    	...
    	return {
    		...
    		p(new_ctx, dirty) {
    			...
    			if (!updating_value && dirty & /*model*/ 1) {
    				updating_value = true;
    				textinput_changes.value = /*item*/ ctx[8];
    ...
    // (47:8) {#if itemType == collectionTypes.track}
    function create_if_block$4(ctx) {
    	let track_1;
    	let current;
    	track_1 = new Track({ props: { model: /*item*/ ctx[8] } });
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			...
    			if (dirty & /*model*/ 1) track_1_changes.model = /*item*/ ctx[8];
    ...
    // (46:4) <ListItem item={item} move={move} remove={remove}>
    ...
    function create_each_block$4(ctx) {
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			...
    			if (dirty & /*$$scope, model, itemType*/ 2053) {
    ...
    function create_fragment$6(ctx) {
    	...
    	return {
    		...
    		p(ctx, [dirty]) {
    			if ((!current || dirty & /*model*/ 1) && t0_value !== (t0_value = /*model*/ ctx[0].length + "")) set_data(t0, t0_value);
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	let { model = [] } = $$props;
    	let { capacity = 10 } = $$props;
    	let { update } = $$props;
    	let { itemType = collectionTypes.simple } = $$props;

    	function add() {
    		if (model.length == capacity) return;
    		if (itemType == collectionTypes.simple) model.push(''); else if (itemType == collectionTypes.track) model.push(track());
    		$$invalidate(0, model);
    		if (update) update();
    	}
    	...
    	function textinput_value_binding(value, item, each_value, item_index) {
    	...
    	return [model, capacity, itemType, add, move, remove, update, textinput_value_binding];
    }
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(span, "class", "align-self-center text-right border-right pr-1 py-2 font-weight-bold");
    			set_style(span, "width", "6.0em");
    			set_style(span, "height", "2.5em");
    			attr(div0, "class", "align-self-center ml-1");
    			attr(div1, "class", "d-flex col-6");
    		},
    		m(target, anchor) {
    ...
    function create_each_block_2(ctx) {
    	...
    	function textinput_content_binding(value) {
    		/*textinput_content_binding*/ ctx[2](value, /*edge*/ ctx[10], /*each_value_2*/ ctx[11], /*edge_index*/ ctx[12]);
    	}

    	let textinput_props = {};

    	if (/*edge*/ ctx[10] !== void 0) {
    		textinput_props.content = /*edge*/ ctx[10];
    	}
    	...
    	return {
    		...
    		p(new_ctx, dirty) {
    			...
    			if (!updating_content && dirty & /*model*/ 1) {
    				updating_content = true;
    				textinput_changes.content = /*edge*/ ctx[10];
    				add_flush_callback(() => updating_content = false);
    			}
    ...
    // (31:2) <Details title="Edges" size="col-lg-3 col-6">
    function create_default_slot_4(ctx) {
    	let each_1_anchor;
    	let current;
    	let each_value_2 = /*model*/ ctx[0].edges;
    	let each_blocks = [];
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			if (dirty & /*model*/ 1) {
    				each_value_2 = /*model*/ ctx[0].edges;
    				let i;
    ...
    // (37:3) {#each model.drives as drive}
    function create_each_block_1(ctx) {
    	let textinput;
    	let updating_content;
    	let current;

    	function textinput_content_binding_1(value) {
    		/*textinput_content_binding_1*/ ctx[3](value, /*drive*/ ctx[7], /*each_value_1*/ ctx[8], /*drive_index*/ ctx[9]);
    	}

    	let textinput_props = {};

    	if (/*drive*/ ctx[7] !== void 0) {
    		textinput_props.content = /*drive*/ ctx[7];
    	}

    	textinput = new TextInput({ props: textinput_props });
    	binding_callbacks.push(() => bind(textinput, 'content', textinput_content_binding_1));
    	...
    	return {
    		...
    		p(new_ctx, dirty) {
    			...
    			if (!updating_content && dirty & /*model*/ 1) {
    				updating_content = true;
    				textinput_changes.content = /*drive*/ ctx[7];
    				add_flush_callback(() => updating_content = false);
    			}
    ...
    // (36:2) <Details title="Drives" size="col-lg-3 col-6">
    function create_default_slot_3(ctx) {
    	let each_1_anchor;
    	let current;
    	let each_value_1 = /*model*/ ctx[0].drives;
    	let each_blocks = [];
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			if (dirty & /*model*/ 1) {
    				each_value_1 = /*model*/ ctx[0].drives;
    				let i;
    ...
    // (43:4) {#each model.skills as skill}
    function create_each_block(ctx) {
    	let skill;
    	let current;
    	skill = new Skill({ props: { model: /*skill*/ ctx[4] } });
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			const skill_changes = {};
    			if (dirty & /*model*/ 1) skill_changes.model = /*skill*/ ctx[4];
    ...
    // (41:2) <Details open={false} title="Skills">
    function create_default_slot_2(ctx) {
    	let div;
    	let current;
    	let each_value = /*model*/ ctx[0].skills;
    	let each_blocks = [];
    ...
    // (48:2) <Details open={false} title="Aspects">
    ...
    // (54:2) <Details open={false} title="Notes">
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function textinput_content_binding(value, edge, each_value_2, edge_index) {
    		each_value_2[edge_index] = value;
    		$$invalidate(0, model);
    	}

    	function textinput_content_binding_1(value, drive, each_value_1, drive_index) {
    		each_value_1[drive_index] = value;
    		$$invalidate(0, model);
    	}

    	return [
    		model,
    		navbar_model_binding,
    		textinput_content_binding,
    		textinput_content_binding_1
    	];
    }
