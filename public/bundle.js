(function () {
    ...
    function create_else_block$4(ctx) {
    	...
    	function select_block_type_1(ctx, dirty) {
    		if (/*matches*/ ctx[1].length == 0) return create_if_block_1$4;
    ...
    class TextArea extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$b, create_fragment$b, safe_not_equal, { content: 0, highlight: 7 });
    	}
    }
    ...
    // (29:8) {#each arr as x,i}
    function create_each_block$4(ctx) {
    	let button;
    	let t;
    	let mounted;
    	let dispose;
    	let if_block = /*model*/ ctx[0].burn > /*i*/ ctx[10] && create_if_block$6();
    	...
    	return {
    		c() {
    			...
    			toggle_class(button, "btn-dark", /*model*/ ctx[0].mark > /*i*/ ctx[10]);
    			toggle_class(button, "btn-light", /*model*/ ctx[0].mark <= /*i*/ ctx[10]);
    		},
    		m(target, anchor) {
    			insert(target, button, anchor);
    ...
    function create_fragment$7(ctx) {
    	...
    	function textinput_content_binding(value) {
    		/*textinput_content_binding*/ ctx[4](value);
    	}
    	...
    	return {
    		c() {
    			...
    			div2 = element("div");
    			button0 = element("button");
    			button0.textContent = "Burn-";
    			t3 = space();
    			button1 = element("button");
    			button1.textContent = "Burn+";
    			attr(div1, "class", "m-1");
    			...
    			attr(div3, "class", "d-flex m-1");
    			attr(div4, "class", "flew-grow-1");
    		},
    		m(target, anchor) {
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	const click_handler_1 = () => burn(-1);
    	const click_handler_2 = () => burn(1);
    ...
    function create_fragment$6(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div4, "class", "d-flex m-1");
    			attr(div5, "class", "flew-grow-1");
    		},
    		m(target, anchor) {
    			insert(target, div5, anchor);
    			append(div5, div0);
    ...
    function create_if_block_1$2(ctx) {
    	let skill_1;
    	let current;
    	skill_1 = new Skill({ props: { model: /*item*/ ctx[8] } });
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			...
    			if (dirty & /*model*/ 1) skill_1_changes.model = /*item*/ ctx[8];
    ...
    // (49:4) <ListItem item={item} move={move} remove={remove}>
    function create_default_slot$1(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		...
    		if (/*itemType*/ ctx[2] == collectionTypes.skill) return 1;
    		return 2;
    	}
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	function add() {
    		...
    		if (itemType == collectionTypes.simple) model.push(''); else if (itemType == collectionTypes.skill) model.push(skill()); else if (itemType == collectionTypes.track) model.push(track());
    		$$invalidate(0, model);
    		if (update) update();
    	}
    ...
    // (31:2) <Details open={false} title="Skills">
    function create_default_slot_2(ctx) {
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			...
    			if (dirty & /*model*/ 1) collection_changes.model = /*model*/ ctx[0].skills;
    ...
    // (37:2) <Details open={false} title="Aspects">
    ...
    // (43:2) <Details open={false} title="Notes">
