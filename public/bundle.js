(function () {
	...
	function create_else_block$7(ctx) {
		...
		function select_block_type_1(ctx, dirty) {
			if (/*matches*/ ctx[2].length == 0) return create_if_block_1$5;
	...
	class TextArea extends SvelteComponent {
		constructor(options) {
			super();
			init(this, options, instance$d, create_fragment$d, safe_not_equal, { content: 0, highlight: 8, label: 1 });
		}
	}
	...
	function create_if_block$9(ctx) {
		...
		let mounted;
		let dispose;
		let if_block = /*label*/ ctx[1] && create_if_block_1$4(ctx);
	...
	class TextInput extends SvelteComponent {
		constructor(options) {
			super();
			init(this, options, instance$c, create_fragment$c, safe_not_equal, { content: 0, label: 1 });
		}
	}
	...
	function create_else_block$4(ctx) {
		...
		let mounted;
		let dispose;
		let each_value_1 = ensure_array_like(/*arr*/ ctx[4]);
		let each_blocks = [];
		...
		return {
			c() {
				...
				attr(div1, "class", "d-flex flex-grow-1 mt-1");
			},
			m(target, anchor) {
				...
				if (!mounted) {
					dispose = listen(button, "click", /*click_handler_9*/ ctx[19]);
					mounted = true;
				}
			},
			p(ctx, dirty) {
				...
				if (dirty & /*model, handleClick, arr*/ 81) {
					each_value_1 = ensure_array_like(/*arr*/ ctx[4]);
					let i;
	...
	function create_if_block$7(ctx) {
		...
		function textinput_content_binding(value) {
			/*textinput_content_binding*/ ctx[8](value);
		}
		...
		return {
			c() {
				...
				attr(button4, "class", "btn border btn-light");
				attr(button5, "class", "btn border btn-light");
				attr(button6, "class", "btn border btn-light");
				attr(button7, "class", "btn border btn-danger");
				attr(div7, "class", "mt-1 flex-grow 1");
				attr(div8, "class", "col-12 border p-3 mt-1");
			},
			m(target, anchor) {
				...
				if (!mounted) {
					dispose = [
						...
						listen(button4, "click", /*click_handler_5*/ ctx[15]),
						listen(button5, "click", /*click_handler_6*/ ctx[16]),
						listen(button6, "click", /*click_handler_7*/ ctx[17]),
						listen(button7, "click", /*click_handler_8*/ ctx[18])
					];
	...
	// (80:8) {#each arr as x,i}
	function create_each_block_1$1(ctx) {
		let button;
		let t;
		let mounted;
		let dispose;
		let if_block = /*model*/ ctx[0].burn > /*i*/ ctx[23] && create_if_block_2();

		function click_handler_10() {
			return /*click_handler_10*/ ctx[20](/*i*/ ctx[23]);
		}
		...
		return {
			c() {
				...
				toggle_class(button, "btn-dark", /*model*/ ctx[0].mark > /*i*/ ctx[23]);
				toggle_class(button, "btn-light", /*model*/ ctx[0].mark <= /*i*/ ctx[23]);
			},
			m(target, anchor) {
				insert(target, button, anchor);
	...
	// (47:12) {#each arr as x,i}
	function create_each_block$7(ctx) {
		let button;
		let t;
		let mounted;
		let dispose;
		let if_block = /*model*/ ctx[0].burn > /*i*/ ctx[23] && create_if_block_1$3();

		function click_handler() {
			return /*click_handler*/ ctx[9](/*i*/ ctx[23]);
		}
	...
	function instance$9($$self, $$props, $$invalidate) {
		...
		const click_handler_5 = () => $$invalidate(3, editing = false);
		const click_handler_6 = () => move(-1);
		const click_handler_7 = () => move(1);
		...
		const click_handler_9 = () => $$invalidate(3, editing = true);
		const click_handler_10 = i => handleClick(i);
		...
		$$self.$$.update = () => {
			if ($$self.$$.dirty & /*model*/ 1) {
				$$invalidate(4, arr = [...new Array(model.size)]);
			}
		};
	...
	class Track extends SvelteComponent {
		constructor(options) {
			super();
			init(this, options, instance$9, create_fragment$9, safe_not_equal, { model: 0, remove: 1, move: 2 });
		}
	}
	...
	// (44:0) {#if (!capacity || model.length < capacity) && allowAdd}
	...
	function create_else_block$3(ctx) {
		...
		function func_2() {
			return /*func_2*/ ctx[11](/*item*/ ctx[13]);
		}

		function taginput_content_binding(value) {
			/*taginput_content_binding*/ ctx[12](value, /*item*/ ctx[13], /*each_value*/ ctx[14], /*item_index*/ ctx[15]);
		}

		let taginput_props = { remove: func_2 };

		if (/*item*/ ctx[13] !== void 0) {
			taginput_props.content = /*item*/ ctx[13];
		}
		...
		return {
			...
			p(new_ctx, dirty) {
				...
				if (dirty & /*model*/ 1) taginput_changes.remove = func_2;

				if (!updating_content && dirty & /*model*/ 1) {
					updating_content = true;
					taginput_changes.content = /*item*/ ctx[13];
					add_flush_callback(() => updating_content = false);
				}
	...
	function create_if_block$6(ctx) {
		...
		function func(...args) {
			return /*func*/ ctx[9](/*item*/ ctx[13], ...args);
		}

		function func_1() {
			return /*func_1*/ ctx[10](/*item*/ ctx[13]);
		}
		...
		return {
			...
			p(new_ctx, dirty) {
				...
				if (dirty & /*model*/ 1) track_1_changes.model = /*item*/ ctx[13];
				if (dirty & /*model*/ 1) track_1_changes.move = func;
				if (dirty & /*model*/ 1) track_1_changes.remove = func_1;
	...
	function instance$8($$self, $$props, $$invalidate) {
		...
		const func = (item, n) => move(n, item);
		const func_1 = item => remove(item);
		const func_2 = item => remove(item);
